...
```sql
DROP TABLE TB_CPK_SWAP_TST;

CREATE TABLE TB_CPK_SWAP_TST (
  A INT NOT NULL,
  B INT NOT NULL,
  NAME VARCHAR(200) NOT NULL,
  CONSTRAINT PK_TB_CPK_SWAP_TST PRIMARY KEY (A, B)
);

INSERT INTO TB_CPK_SWAP_TST (A, B, NAME) VALUES ('1', '2', '홍길동');
INSERT INTO TB_CPK_SWAP_TST (A, B, NAME) VALUES ('3', '4', '이순신');

-- 동일한 복합 기본 키로 변경 (오류 발생)
UPDATE TB_CPK_SWAP_TST SET A = '3', B = '4' WHERE NAME = '홍길동';

UPDATE TB_CPK_SWAP_TST
SET
  A = CASE
